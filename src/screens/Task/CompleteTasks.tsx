...
import timeSucces from "../../images/timwSucces.svg"; // Note: "timwSucces" might be a typo, should it be "timeSuccess"?
...
const CompleteTasks = ({ refresh }: Props) => {
  ...
  const SHEET_TITLE = "Bajarilganlar";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredData.map((item, index) => (
            <div key={index} className="p-4 bg-[#FCFCFC] rounded-lg shadow-sm flex flex-col">
              ...
              <button className="py-1 px-3 rounded-md text-[#FCFCFC] text-sm text-normal bg-[#475BE8] ml-auto">
